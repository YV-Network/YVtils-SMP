...
public class CreateFile_de {
    ...
    public void StringInput() {
        ...
        ymlFile.addDefault("MSG_PLAYER_WENT_OFFLINE", "PREFIX §4Der Spieler mit welchem du zuletzt geschrieben hast ist offline gegangen!");
        ...
        ymlFile.addDefault("MOD_ANNOUNCEMENT_KICK", "PREFIXMODERATION §8PLAYER §7wurde von §8MODERATOR §7gekickt! Grund: §8REASON");
